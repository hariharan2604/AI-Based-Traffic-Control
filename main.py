...
if __name__ == "__main__":
    ...
    logging.info("✅ All WebSocket servers are initialized. Starting video processing and traffic control.")
    mqtt_client = start_mqtt()
    video_threads, video_processors = start_video_processing(mqtt_client, ws_servers)

    signal_management_thread = threading.Thread(target=cycle_signals, args=(mqtt_client, stop_event))
